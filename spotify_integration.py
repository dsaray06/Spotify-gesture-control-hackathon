...
class OverlayWindow(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(150, 0, 400, 100)  # Window size
        self.setAttribute(Qt.WA_TranslucentBackground)

        # Create button with larger QRect
        self.button = QPushButton('Use Hand Gestures', self)
        self.button.setGeometry(QRect(65, 12, 300, 60))  # x, y, width, height

        # Set the button's stylesheet with dark gray background and rounded edges
        self.button.setStyleSheet("""
            background-color: #212121;  /* Dark gray */
            color: #b3b3b3;  /* Lighter gray for text */
            font-size: 20px;
            border-radius: 30px;  /* More rounded edges */
        """)

        # Load font from local font file
        font_id = QFontDatabase.addApplicationFont("C:\\Users\\devsa\\Downloads\\Howdyhack\\circular-std-medium-500.ttf")
